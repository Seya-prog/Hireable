<div class="skill-header">
    <div>
        ...
        <nav class="skill-tabs">
            <a href="skill-assesment.php" class="skill-tab <?= $currentTab === 'available' ? 'active' : '' ?>">Available</a>
            <a href="skill-assesment.php?tab=completed" class="skill-tab <?= $currentTab === 'completed' ? 'active' : '' ?>">Completed</a>
            <a href="skill-assesment.php?tab=progress" class="skill-tab <?= $currentTab === 'progress' ? 'active' : '' ?>">In Progress</a>
        </nav>
    </div>
</div>
