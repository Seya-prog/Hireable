    ...
    <div class="auth-layout">
        ...
        <div class="auth-form-panel">
            <div class="auth-form-wrapper">
                ...
                <form method="POST" action="/action/auth.signup" class="auth-form" novalidate>
                    <?= csrfField() ?>
                    <!-- Role Toggle -->
                        ...
                        <div class="auth-field">
                            ...
                            <div class="auth-input-wrap">
                                <input class="auth-input" id="first-name" name="first_name" type="text"
                                    value="" placeholder="John" required>
                            </div>
                        ...
                        <div class="auth-field">
                            ...
                            <div class="auth-input-wrap">
                                <input class="auth-input" id="last-name" name="last_name" type="text"
                                    value="" placeholder="Doe" required>
                            </div>
                    ...
                    <div class="auth-field">
                        ...
                        <div class="auth-input-wrap">
                            ...
                            <input class="auth-input" id="email" name="email" type="email"
                                value="" placeholder="you@example.com" required>
                        </div>
                ...
                <p class="auth-switch-text">
                    Already have an account? <a href="../auth/login.php" class="auth-switch-link">Sign in</a>
                </p>
            </div>
        </div>
    </div>
