 ...
 */
?>
<a href="../employer/job-detail.php?id=<?= $job['id'] ?? '' ?>" class="emp-job-card" data-filter-item data-status="<?= $statusType ?>" data-searchable="<?= strtolower($jobTitle . ' ' . $department . ' ' . $location) ?>" style="text-decoration:none; color:inherit;">
