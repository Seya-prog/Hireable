...
<div class="emp-assess-card">
    ...
    <div class="emp-assess-card-actions">
        <a href="assessment-detail.php" class="emp-assess-act-btn" style="text-decoration:none; text-align:center;">View Results</a>
        <a href="skill-assesment.php?tab=create" class="emp-assess-act-btn emp-assess-act-btn--outline" style="text-decoration:none; text-align:center;">Edit</a>
    </div>
</div>
